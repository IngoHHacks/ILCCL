...
internal static class Secrets
{
    ...
    public static readonly string[] EasterEggs =
    {
        ...
        "Did you know that ILCCL is secretly a recursive acronym? It stands for \"ILCCL Tramples Code Complexity Lazily\".",
        "Dit is geen paasei.",
        "Do you hate ILCCL? If so, remember to leave a dislike and a hate comment. Your feedback is greatly appreciated.",
        ...
        "GamingMaster wrote another pull request for ILCCL. IngoH: \"Wow, that's a lot of code!\" GamingMaster: \"Yeah, I know. I'm a good programmer.\"",
        "Ha! You just wasted your one in a thousand chance on this easter egg! Sucker!",
        "Hello, player. I'd like to play a game. You have been trapped in a room with a computer that has Infinite Lives installed on it. The only way to escape is beat every single character in the game in every single court case type. If you fail, you will be locked in the room forever. Good luck.",
        "Hey, Vsauce, Ingo here. Do you know what a Infinite Lives is? You'll probably say something like \"Of course I do, Ingo, I'm not an idiot.\" But what if I told you that you're wrong?",
        "Hey, you. You're finally awake. You were trying to play modded Infinite Lives, right? Walked right into that Mat Dickie ambush, same as us, and that prisoner over there.",
        ...
        "I visited the modding server of Infinite Lives to have some friendly chat. At that point, I was trolled by a user named \"Mat Dickie\".",
        "I'm a dog. Woof woof. I wear egg shells. That's my thing.",
        "I'm a good programmer - Mat Dickie, probably.",
        "I'm going to hack Mat's code and make it so that every time you use Infinite Lives, it automatically downloads ILCCL. - IngoH, probably.",
        ...
        "Introducing: ILCCL Lite! Same content loader, but zero calories!",
        $"It is the year {DateTime.Now.Year + 450}. Mat Dickie pushed out another update for Infinite Lives that broke all the mods. Ingo is still trying to fix his mod. He has been trying to fix it for 450 years. He is still not done.",
        "It's dangerous to go alone! Take this: a copy of Infinite Lives.",
        "It's said that if you say \"ILCCL\" three times in front of a mirror, you will be visited by the ghost of Mat Dickie.",
        ...
        "Man tries installing ILCCL to mod Infinite Lives. What happens next will shock you!",
        ...
        "Sorry, but ILCCL is actually a dating sim. You've been playing it wrong this whole time.",
        ...
        "That's a lot of mods you have installed. The developers are of ILCCL are impressed. Due to the nature of ILCCL, any comments about the amount of mods you have installed are speculation on our part. Please disregard this message if you do not have a lot of mods installed.",
        ...
        "The code is a lie.",
        "The real ILCCL is the friends we made along the way.",
        ...
        "To be fair, you have to have a very high IQ to understand ILCCL. The code is extremely subtle, and without a solid grasp of theoretical physics most of the code will go over a typical programmer's head.",
        "To mod or not to mod, that is the question.",
        "Touch grass. Now.",
        "Turns out Mat Dickie never existed. He was just a figment of your imagination.",
        "Turns out Mat's new game, Infinite Lives, is just a reskin of Infinite Lives. Who would've thought?",
        "Turns out Mat's new game, Old School, is just a reskin of Infinite Lives. Who would've thought?",
        "Uh oh, stinky. That's what I say whenever I look at Mat Dickie's code.",
        "UwU, what's this? *notices your code*",
        "ILCCL 2: Electric Boogaloo - Coming soon to a Steam Workshop near you.",
        "ILCCL DELUXE: IngoH Deletes Mat Dickie's Code - Coming soon to a Steam Workshop near you.",
        "ILCCL II: The Prisoners Strike Back - Coming soon to a Steam Workshop near you.",
        "ILCCL PLUS: Mat Dickie's Revenge - Coming soon to a Steam Workshop near you.",
        "ILCCL Terms of Service: By using this mod, you agree to give Ingo all your money. You also agree to give Ingo all your belongings, including your house, your car, your family, your pets, and your soul. Furthermore, Ingo will be allowed to use your belongings in any way he wants, including but not limited to: selling them, destroying them, eating them, and using them to build a giant statue of himself. If you do not agree to these terms, you are not allowed to use this mod.",
        "ILCCL is a mod for Infinite Lives. But what if I told you that Infinite Lives is actually a mod for ILCCL? Think about it.",
        "ILCCL is a mod. I don't know what that means, but it sounds cool.",
        "ILCCL is a virus, by the way. Ingo made it to steal your money to buy dog treats.",
        "ILCCL is made by some idiot named Ingo and a few other idiots.",
        "ILCCL: The Movie: Mat Dickie F*cking Dies - Coming soon to a movie theater near you.",
        ...
        "What if... we kissed... in the Infinite Lives ring... haha, just kidding... unless?",
        "What's a Mat Dickie? And why is it breaking my mod?",
        "Why are there no dinosaurs in Infinite Lives? It's because Mat Dickie himself is a dinosaur. His ancient code is proof of that.",
        "Why do they call it a ILCCL when you can't even clc?",
        ...
        "Infinite Lives is actually a roguelike. If you die in the game, you die in real life! Haha, just kidding. Or am I?",
    ...
    public static string GetConditionalEasterEgg()
    {
        switch (MetaFile.Data.TimesLaunched)
        {
            // Times Launched
            case 69:
                return "Nice. You started ILCCL 69 times. You are officially a cool person.";
            case 100:
                return "Congratulations! You started ILCCL 100 times! Go outside and touch grass now.";
            case 420:
                return "You started ILCCL 420 times. It's time to blaze it.";
            case 1000:
                return "Wow! You started ILCCL 1000 times! You must really like this mod.";
            case 6969:
                return "Nicenice. You started ILCCL 6969 times. That's very nice.";
            case 10000:
                return "You started ILCCL 10000 times! You are officially a ILCCL addict. Please seek help.";
            case 42069:
                return "You started ILCCL 42069 times. That's a number that's funny for some reason.";
            case 69420:
                return "You started ILCCL 69420 times. That's also a number that's funny for some reason.";
            case 100000:
                return "OMG! You started ILCCL 100000 times! You are officially the biggest ILCCL fan ever!.";
            case 696969:
                return "Nicenicenice. You started ILCCL 696969 times. That's extremely nice.";
            case 1000000:
                return
                    "You started ILCCL one million times! That's it, I'm calling the police. You are a danger to society. Or perhaps you cheated by editing the meta file..";
            case 1000000000:
                return
                    "So, you started ILCCL one billion times. That's cool, I guess. But did you know Ingo doesn't care? That's right! Ingo doesn't care about you or your stupid billion launches. He only cares about dog treats. So stop wasting your time and go buy Ingo some dog treats.";
            case 2147483647:
                return
                    "Oh no! You started ILCCL so many times that the number of times you started it can't go any higher! Congratulations, you broke the game. You must now uninstall ILCCL and never play it again.";
            case < 0:
                return
                    "You started ILCCL a negative number of times. That's not possible. How did you do that? Did you hack the game? Or did you just edit the meta file?";
            case 0:
                return
                    "You started ILCCL zero times. That's not possible. How did you do that? Did you hack the game? Or did you just edit the meta file?";
        }
        ...
        {
            return
                "IngoH just announced that ILCCL is in fact going to be deleted. Haha, April Fools!";
        }
        ...
        {
            return
                "Boo! Did I scare you? No? Well, I tried. Happy Halloween from IngoH and the rest of the ILCCL team!";
        }

        if (DateTime.Now.Month == 1 && DateTime.Now.Day == 1)
        {
            return
                "Happy New Year! Go make some New Year's resolutions. And don't forget to include \"play ILCCL more\" in them.";
        }

        if (DateTime.Now.Month == 2 && DateTime.Now.Day == 14)
        {
            return
                "Happy Valentine's Day! I hope you have a great day with your loved ones. Or if you don't have any loved ones, I hope you have a great day playing ILCCL.";
        }

        if (DateTime.Now.Month == 2 && DateTime.Now.Day == 29)
        {
            return "Oh no! It's a leap year! That means you have to play ILCCL one more day this year! I'm so sorry.";
        }
        ...
        {
            return
                "It's midnight! You should probably go to sleep now. Or you could stay up all night playing ILCCL. I'm not your mom, I can't tell you what to do.";
        }

        if (DateTime.Now.Hour == 3 && DateTime.Now.Minute == 0)
        {
            return "Playing ILCCL at 3 AM challenge? That's so 2016. But hey! I'm not judging. You do you.";
        }

        if (DateTime.Now.Hour == 4 && DateTime.Now.Minute == 20)
        {
            return
                "It's 4:20! You know what that means! It's time to blaze it! Or you could just play ILCCL. That's cool too.";
        }
        ...
        {
            MetaFile.Data.PreviousUser = Environment.UserName;
            return "Hey, Mat! Thank you for using ILCCL. Have a great day!";
        }

        if (Environment.HasShutdownStarted)
        {
            return
                "It appears that your computer is shutting down at this very moment. Why are you shutting down your computer? Are you done playing ILCCL? I hope you had fun!";
        }

        if (Environment.TickCount <= 60000)
        {
            return "You started ILCCL less than a minute after you started your computer. That's pretty impressive.";
        }

        if (Environment.TickCount >= 1000 * 60 * 60 * 24 * 7 && Random.Range(0, 1000) == 0)
        {
            return
                "You started ILCCL more than a week after you started your computer. I'm not judging, but you should probably restart your computer every once in a while.";
        }
