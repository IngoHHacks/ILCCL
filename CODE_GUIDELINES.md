# Code Guidelines
General guidelines for contributing to ILCCL.  
...
* For example, `UnmappedPlayer` instead of `Player`. Classes that are not obfuscated (e.g. `Character`) can be used as-is.
...
* ILCCL uses internal mappings to access game methods and fields. These mappings are kept secret. Ask @IngoH for more information.
